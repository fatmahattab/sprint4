...
public class SecurityConfig  {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.csrf().disable()
                        ...
                        .requestMatchers("/showCreate", "/saveFruit" ).hasAnyAuthority("ADMIN","AGENT")
                        .requestMatchers("/ListeFruits").hasAnyAuthority("ADMIN","AGENT","USER")
                        .requestMatchers("/supprimerFruit","/modifierFruit","/updateFruit").hasAuthority("ADMIN")
                .anyRequest().authenticated().and()
                                .formLogin(form -> form
                                        .loginPage("/login")
                                        .defaultSuccessUrl("/ListeFruits", true)
